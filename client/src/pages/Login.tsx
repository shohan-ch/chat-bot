...
export const Login:FC<{getLogin:Function}> = ({getLogin})=>{
    ...
    return (
        <div>
            <form onSubmit={doLogin} style={{backgroundColor:'#2c2f34', padding:'10px', position:'relative', border:'1px solid gray',width:'350px'}}>
                ...
                <div className="form-control">
                    <button type="submit" style={{color:'white',padding:'5px',width:'100%', backgroundColor:'indigo',border:'1px solid indigo'}}>Login</button>
                </div>
            </form>
        </div>
    )
